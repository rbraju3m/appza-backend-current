                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">
                            <h6>{{__('messages.UpdateMatrix')}}</h6>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                {{ html()->modelForm($licenseLogic, 'PATCH', route('license_logic_update', $licenseLogic->id))
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group row mg-top">
                                        ...
                                        <div class="col-sm-4">
                                            {{ html()->select('event', $eventDropdown, $licenseLogic->event)
                                    ...
                                    <div class="form-group row mg-top" id="directionRow">
                                        ...
                                        <div class="col-sm-4">
                                            {{ html()->select('direction', $directionDropdown,$licenseLogic->direction)
                                                ->class('form-control form-select js-example-basic-single')
                                                ->attribute('aria-describedby', 'basic-addon2')
                                            }}
                                    ...
                                    <div class="form-group row mg-top" id="daysRow">
                                        ...
                                        <div class="col-sm-4">
                                            {{ html()->select('from_days', $toDaysDropdown,$licenseLogic->from_days)
                                                ->class('form-control form-select js-example-basic-single')
                                                ->attribute('aria-describedby', 'basic-addon2')
                                            }}
                                        ...
                                        <div class="col-sm-4">
                                            {{ html()->select('to_days', $toDaysDropdown,$licenseLogic->to_days)
                                                ->class('form-control form-select js-example-basic-single')
                                                ->attribute('aria-describedby', 'basic-addon2')
                                            }}
