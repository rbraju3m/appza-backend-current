    ...
    <p style="color: black;text-align: justify">Thank you for submitting your request for [<b>{{$details['app_name']}}</b>] App, the development of [<b>{{$details['app_name']}}</b>]. We’re excited to begin the build process and bring your project to life!</p>
