                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                {{ html()
                                    ->form('POST', route('license_message_store'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group row mg-top">
                                        ...
                                        <div class="col-sm-4">
                                            {{ html()
                                                ->select('license_logic_id', $matrixs, '')
                                                ->class('form-control form-select js-example-basic-single')
                                                ->attribute('aria-describedby', 'basic-addon2')
                                    ...
                                    <div class="form-group row mg-top">
                                        ...
                                        <div class="col-sm-4">
                                            {{ html()
                                                ->select('license_type', $licenseType , '')
                                                ->class('form-control form-select js-example-basic-single')
                                                ->attribute('aria-describedby', 'basic-addon2')
...
{{--                                            <span class="textRed">{!! $errors->first('message_admin') !!}</span>--}}
                                        </div>
                                    </div>
...
{{--                                            <span class="textRed">{!! $errors->first('message_special') !!}</span>--}}
                                        </div>
                                    </div>
